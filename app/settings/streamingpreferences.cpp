...
#define SER_TELEMETRY "telemetryEnabled"
#define SER_CRASHREPORTING "crashReportingEnabled"
...
void StreamingPreferences::reload()
{
    ...
    telemetryEnabled = settings.value(SER_TELEMETRY, true).toBool();
    crashReportingEnabled = settings.value(SER_CRASHREPORTING, true).toBool();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_TELEMETRY, telemetryEnabled);
    settings.setValue(SER_CRASHREPORTING, crashReportingEnabled);
