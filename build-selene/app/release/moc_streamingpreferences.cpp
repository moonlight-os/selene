...
template <> constexpr inline auto StreamingPreferences::qt_create_metaobjectdata<qt_meta_tag_ZN20StreamingPreferencesE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'rendererSelectionChanged'
        QtMocHelpers::SignalData<void()>(37, 2, QMC::AccessPublic, QMetaType::Void),
        // Method 'getDefaultBitrate'
        QtMocHelpers::MethodData<int(int, int, int, bool)>(38, 2, QMC::AccessPublic, QMetaType::Int, {{
            { QMetaType::Int, 39 }, { QMetaType::Int, 40 }, { QMetaType::Int, 41 }, { QMetaType::Bool, 42 },
        }}),
        // Method 'save'
        QtMocHelpers::MethodData<void()>(43, 2, QMC::AccessPublic, QMetaType::Void),
        // Method 'retranslate'
        QtMocHelpers::MethodData<bool()>(44, 2, QMC::AccessPublic, QMetaType::Bool),
    };
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<int>(45, QMetaType::Int, QMC::DefaultPropertyFlags | QMC::Writable, 1),
        // property 'unlockBitrate'
        QtMocHelpers::PropertyData<bool>(46, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 2),
        // property 'autoAdjustBitrate'
        QtMocHelpers::PropertyData<bool>(47, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 3),
        // property 'enableVsync'
        QtMocHelpers::PropertyData<bool>(48, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 4),
        // property 'gameOptimizations'
        QtMocHelpers::PropertyData<bool>(49, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 5),
        // property 'playAudioOnHost'
        QtMocHelpers::PropertyData<bool>(50, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 6),
        // property 'multiController'
        QtMocHelpers::PropertyData<bool>(51, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 7),
        // property 'enableMdns'
        QtMocHelpers::PropertyData<bool>(52, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 9),
        // property 'quitAppAfter'
        QtMocHelpers::PropertyData<bool>(53, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 10),
        // property 'absoluteMouseMode'
        QtMocHelpers::PropertyData<bool>(54, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 11),
        // property 'absoluteTouchMode'
        QtMocHelpers::PropertyData<bool>(55, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 12),
        // property 'framePacing'
        QtMocHelpers::PropertyData<bool>(56, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 20),
        // property 'connectionWarnings'
        QtMocHelpers::PropertyData<bool>(57, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 21),
        // property 'configurationWarnings'
        QtMocHelpers::PropertyData<bool>(58, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 22),
        // property 'richPresence'
        QtMocHelpers::PropertyData<bool>(59, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 23),
        // property 'gamepadMouse'
        QtMocHelpers::PropertyData<bool>(60, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 24),
        // property 'detectNetworkBlocking'
        QtMocHelpers::PropertyData<bool>(61, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 25),
        // property 'showPerformanceOverlay'
        QtMocHelpers::PropertyData<bool>(62, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 26),
        // property 'audioConfig'
        QtMocHelpers::PropertyData<enum AudioConfig>(63, 0x80000000 | 64, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag, 13),
        // property 'videoCodecConfig'
        QtMocHelpers::PropertyData<enum VideoCodecConfig>(65, 0x80000000 | 66, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag, 14),
        // property 'enableHdr'
        QtMocHelpers::PropertyData<bool>(67, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 15),
        // property 'enableYUV444'
        QtMocHelpers::PropertyData<bool>(68, QMetaType::Bool, QMC::DefaultPropertyFlags | QMC::Writable, 16),
        // property 'videoDecoderSelection'
        QtMocHelpers::PropertyData<enum VideoDecoderSelection>(69, 0x80000000 | 70, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag, 17),
        // property 'rendererSelection'
        QtMocHelpers::PropertyData<enum RendererSelection>(71, 0x80000000 | 72, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag, 35),
        // property 'windowMode'
        ...
        QtMocHelpers::PropertyData<enum CaptureSysKeysMode>(84, 0x80000000 | 85, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag, 32),
        // property 'language'
        QtMocHelpers::PropertyData<enum Language>(86, 0x80000000 | 87, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag, 34),
    };
    QtMocHelpers::UintData qt_enums {
        // enum 'AudioConfig'
        QtMocHelpers::EnumData<enum AudioConfig>(64, 64, QMC::EnumFlags{}).add({
            {   88, AudioConfig::AC_STEREO },
            {   89, AudioConfig::AC_51_SURROUND },
            {   90, AudioConfig::AC_71_SURROUND },
        }),
        // enum 'VideoCodecConfig'
        QtMocHelpers::EnumData<enum VideoCodecConfig>(66, 66, QMC::EnumFlags{}).add({
            {   91, VideoCodecConfig::VCC_AUTO },
            {   92, VideoCodecConfig::VCC_FORCE_H264 },
            {   93, VideoCodecConfig::VCC_FORCE_HEVC },
            {   94, VideoCodecConfig::VCC_FORCE_HEVC_HDR_DEPRECATED },
            {   95, VideoCodecConfig::VCC_FORCE_AV1 },
        }),
        // enum 'VideoDecoderSelection'
        QtMocHelpers::EnumData<enum VideoDecoderSelection>(70, 70, QMC::EnumFlags{}).add({
            {   96, VideoDecoderSelection::VDS_AUTO },
            {   97, VideoDecoderSelection::VDS_FORCE_HARDWARE },
            {   98, VideoDecoderSelection::VDS_FORCE_SOFTWARE },
        }),
        // enum 'RendererSelection'
        QtMocHelpers::EnumData<enum RendererSelection>(72, 72, QMC::EnumFlags{}).add({
            {   99, RendererSelection::RS_PROBE_ONLY },
            {  100, RendererSelection::RS_AUTO },
            {  101, RendererSelection::RS_VULKAN },
            {  102, RendererSelection::RS_METAL },
            {  103, RendererSelection::RS_AVSBDL },
        }),
        // enum 'WindowMode'
        ...
        // enum 'Language'
        QtMocHelpers::EnumData<enum Language>(87, 87, QMC::EnumFlags{}).add({
        ...
        QtMocHelpers::EnumData<enum CaptureSysKeysMode>(85, 85, QMC::EnumFlags{}).add({
...
void StreamingPreferences::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 35: _t->rendererSelectionChanged(); break;
        case 36: { int _r = _t->getDefaultBitrate((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[4])));
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (StreamingPreferences::*)()>(_a, &StreamingPreferences::languageChanged, 34))
            return;
        if (QtMocHelpers::indexOfMethod<void (StreamingPreferences::*)()>(_a, &StreamingPreferences::rendererSelectionChanged, 35))
            return;
    }
    if (_c == QMetaObject::ReadProperty) {
        ...
        case 26: *reinterpret_cast<enum RendererSelection*>(_v) = _t->rendererSelection; break;
        case 27: *reinterpret_cast<enum WindowMode*>(_v) = _t->windowMode; break;
        case 28: *reinterpret_cast<enum WindowMode*>(_v) = _t->recommendedFullScreenMode; break;
        case 29: *reinterpret_cast<enum UIDisplayMode*>(_v) = _t->uiDisplayMode; break;
        case 30: *reinterpret_cast<bool*>(_v) = _t->swapMouseButtons; break;
        case 31: *reinterpret_cast<bool*>(_v) = _t->muteOnFocusLoss; break;
        case 32: *reinterpret_cast<bool*>(_v) = _t->backgroundGamepad; break;
        case 33: *reinterpret_cast<bool*>(_v) = _t->reverseScrollDirection; break;
        case 34: *reinterpret_cast<bool*>(_v) = _t->swapFaceButtons; break;
        case 35: *reinterpret_cast<bool*>(_v) = _t->keepAwake; break;
        case 36: *reinterpret_cast<enum CaptureSysKeysMode*>(_v) = _t->captureSysKeysMode; break;
        case 37: *reinterpret_cast<enum Language*>(_v) = _t->language; break;
        default: break;
        }
    }
    if (_c == QMetaObject::WriteProperty) {
        ...
        case 25:
            ...
            break;
        case 26:
            if (QtMocHelpers::setProperty(_t->rendererSelection, *reinterpret_cast<enum RendererSelection*>(_v)))
                Q_EMIT _t->rendererSelectionChanged();
            break;
        case 27:
...
// SIGNAL 35
void StreamingPreferences::rendererSelectionChanged()
{
